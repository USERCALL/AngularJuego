...
(function(){
    ...
    var multishot=1;
    var elapsedTime=0;
    var player=new Rectangle(100,380,20,20,0,3);
    var shots=[];
    var enemies=[];
    var powerups=[];
    var messages=[];
    ...
    function reset(){
        ...
        powerups.length=0;
        messages.length=0;
        enemies.push(new Rectangle(100,0,20,10,0,2));
        enemies.push(new Rectangle(200,0,20,10,0,2));
        enemies.push(new Rectangle(300,0,20,10,0,2));
        enemies.push(new Rectangle(400,0,20,10,0,2));
        gameover=false;
    }
    ...
    function act(deltaTime){
        if(!pause){
            ...
            // permanesa dentro de la pantalla
            ...
            if(lastPress==KEY_SPACE){
                ...
                if(multishot==5){
                    ...
                    shots.push(new Rectangle(player.x+7,player.y,5,5));
                    shots.push(new Rectangle(player.x+9,player.y,5,5));
                ...
                if(multishot==3){
                    ...
                    shots.push(new Rectangle(player.x+11,player.y,5,5));
                }
                else if(multishot==2){
                    shots.push(new Rectangle(player.x+7,player.y,5,5));
                    shots.push(new Rectangle(player.x+11,player.y,5,5));
                ...
                for(var j=0,ll=shots.length;j<ll;j++){
                    if(shots[j].intersects(enemies[i])){
                        ...
                        if(enemies[i].health<1){
                            ...
                            enemies[i].y=0;
                            enemies[i].health=2;
                            enemies.push(new Rectangle(random(canvas.width/10)*10,0,20,10,0,2));
                        }
                        else{
                            enemies[i].timer=1;
                        }
    ...
    function paint(ctx){
        ...
        ctx.fillText('Vida: '+player.health,150,20);
